...
SECRET_KEY = "django-insecure-v0l#v#-v+_@&vncc#@(=7+o$7r)857#@klzr^nk@@ws66nnq+u"
...
# Custom User Model
AUTH_USER_MODEL = "dasa_users.User"
...
# Allow custom ngrok header for bypassing browser warning
